...
public class TutorialManagaer : MonoBehaviour
{
    ...
    void DisplayTelop()
    {
        switch(telopNum)
        {
            ...
            case 2:
                if((XBoxInputManager.Instance.XBoxInputButton(XBoxButtonCode.A)|| Input.GetKeyDown(KeyCode.Space)) && CountTime > 1f && !telopChange)
                {
                    telopChange = true;
                    CountTime = 0;
                }
            ...
            case 4:
                if((XBoxInputManager.Instance.XBoxInputButton(XBoxButtonCode.B)|| Input.GetKeyDown(KeyCode.E)) && CountTime > 1f)
                {
                    telopNum = 5;
                }
